...
class ManyToMany_getMapper_Test extends ManyToMany_Test
{
	...
	{
		$this->m2m = new ManyToMany_getMapper_ManyToMany($this->e, $this->r, 'param', 'param', true);
		$this->e->generatingRepository->mapper->mmm = new Directory;
		$this->setExpectedException('Nette\InvalidStateException', "ManyToMany_Mapper::createManyToManyMapper() must return Orm\\IManyToManyMapper, 'Directory' given");
		$this->m2m->gm();
	}
