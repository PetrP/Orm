...
/**
 * @covers Orm\IdentityMap::remove
 */
class IdentityMap_remove_Test extends TestCase
{
	private $im;
	...
	public function test()
	{
		...
		$this->assertSame(NULL, $this->im->remove(123));
	...
	{
		$r = new ReflectionMethod('Orm\IdentityMap', 'remove');
