...
class ValueEntityFragment_callStatic_Test extends TestCase
{
	...
	public function test1()
	{
		...
		$this->setExpectedException('Nette\MemberAccessException', Orm::PACKAGE === '5.2' ? 'Call to undefined static method Orm\Object::foo().' : 'Call to undefined static method Orm\ValueEntityFragment::foo().');
