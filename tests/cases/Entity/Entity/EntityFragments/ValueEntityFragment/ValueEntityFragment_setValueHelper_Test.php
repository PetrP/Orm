...
class ValueEntityFragment_setValueHelper_Test extends TestCase
{
	...
	{
		$this->setExpectedException('UnexpectedValueException', "Param ValueEntityFragment_getset_Entity::\$fk must be 'testentity', 'NULL' given");
		$this->e->fk;
	}
	...
	{
		$e = new ValueEntityFragment_setValueHelper_Entity;
		$this->setExpectedException('Nette\UnexpectedValueException', "Param ValueEntityFragment_setValueHelper_Entity::\$enumString must be ''a', 'b'', 'c' given");
		$e->enumString = 'c';
	}
	...
	{
		$e = new ValueEntityFragment_setValueHelper_Entity;
		$this->setExpectedException('Nette\UnexpectedValueException', "Param ValueEntityFragment_setValueHelper_Entity::\$enumString must be ''a', 'b'', 'NULL' given");
		$e->enumString = NULL;
	}
	...
	{
		$e = new ValueEntityFragment_setValueHelper_Entity;
		$this->setExpectedException('Nette\UnexpectedValueException', "Param ValueEntityFragment_setValueHelper_Entity::\$enumInt must be '1, 2', '3' given");
		$e->enumInt = 3;
	}
	...
	{
		$e = new ValueEntityFragment_setValueHelper_Entity;
		$this->setExpectedException('Nette\UnexpectedValueException', "Param ValueEntityFragment_setValueHelper_Entity::\$enumInt must be '1, 2', 'c' given");
		$e->enumInt = 'c';
	}
	...
	{
		$e = new ValueEntityFragment_setValueHelper_Entity;
		$this->setExpectedException('Nette\UnexpectedValueException', "Param ValueEntityFragment_setValueHelper_Entity::\$enumInt must be '1, 2', 'NULL' given");
		$e->enumInt = NULL;
	}
