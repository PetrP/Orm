...
class MetaDataProperty_setInjection_Test extends TestCase
{
	...
	public function testClassNotImplement()
	{
		...
		$this->setExpectedException('Nette\InvalidStateException', "Directory does not implements Orm\\IEntityInjection in MetaData_Test_Entity::\$id");
		$this->p->setInjection();
	}
	...
	public function testCallbackString()
	{
		...
		try {
			...
			$this->t('MetaDataProperty_setInjection_JustInjection', 'MetaDataProperty_setInjection_Injection::create');
		}
	}
