...
__halt_compiler();
------EXPECT------
Exception MemberAccessException: Cannot %[(assign|write)]% to an undeclared property Test::$neexistuje.

Exception MemberAccessException: Cannot write to an undeclared property Test::$xxx.

Exception MemberAccessException: Cannot %[(assign|write)]% to an undeclared property Test::$aaa.
