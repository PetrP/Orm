 ...
 * @property $callOther2
 */
class EntityValue_gettersetter_Test_Entity extends Entity
{
	...
	{
		$this->{__FUNCTION__.'Count'}++;
		if ($this->throw) throw new EntityValue_setter_Test_Exception();
	...
	{
		$this->{__FUNCTION__.'Count'}++;
		if ($this->throw) throw new EntityValue_getter_Test_Exception();
...
class EntityValue_getter_Test_Exception extends Exception {}
class EntityValue_setter_Test_Exception extends Exception {}
