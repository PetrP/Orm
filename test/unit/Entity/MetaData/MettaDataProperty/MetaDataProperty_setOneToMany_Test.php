...
class MetaDataProperty_setOneToMany_Test extends TestCase
{
	...
	{
		$this->markTestSkipped();
		$this->setExpectedException('InvalidStateException', 'MetaData_Test_Entity::$id {1:m} Class \'Html\' isn\'t subclass of OneToMany');
	...
	{
		$this->markTestSkipped();
		$this->m->addProperty('id', 'OneToMany')
